import AgregarCategoria, {DtoCategoria} from "./AgregarCategoria";
...
const Categorias = () => {
    ...
    const mostrarCategorias = async () => {
        const url = "http://localhost:4000/listar-categorias/listar";
    ...
    const onCrearCategoria = async (categoria: DtoCategoria) => {
        const url = "http://localhost:4000/crear-categoria/crear";
        const resp = await fetch(url, {
            method: "post",
            headers: {
